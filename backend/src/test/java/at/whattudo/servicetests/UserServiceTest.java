...
import at.whattudo.repository.*;
import at.whattudo.service.AttendanceService;
import at.whattudo.service.impl.CustomUserDetailService;
import at.whattudo.entity.*;
...
public class UserServiceTest {
    ...
    public void getRecommendedEvents_shouldReturn_correctEvent() {
        ...
        at.whattudo.entity.Calendar calendar = calendarRepository.save(new at.whattudo.entity.Calendar("Test Calendar Service 3", Collections.singletonList(new Organization())));
    ...
    public void ifNoRecommendableEvents_getRecommendedEvents_shouldReturn_randomEvents() {
        ApplicationUser user = userService.saveNewUser(new ApplicationUser("TestUser 1", "testy1@test.com", "hunter2"));
        at.whattudo.entity.Calendar calendar = calendarRepository.save(new Calendar("Test Calendar Service 3", Collections.singletonList(new Organization())));
        List<Label> labels1 = new ArrayList<>();
        List<Label> labels2 = new ArrayList<>();
        List<Label> labels3 = new ArrayList<>();
        List<Event> events1 = new ArrayList<>();
