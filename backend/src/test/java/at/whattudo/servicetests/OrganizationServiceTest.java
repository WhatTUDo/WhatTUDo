...
public class OrganizationServiceTest {
    ...
    public void removeCalendarsWhenDeletingOrganization_calendarsShouldNotBeAssociatedWithDeletedOrganization() {
        ...
        at.whattudo.entity.Calendar calendar = new at.whattudo.entity.Calendar("Test Cal", new ArrayList<Organization>());
        List<at.whattudo.entity.Calendar> calendarList = new ArrayList<>();
    ...
    public void addCalendarToOrga() {
        ...
        at.whattudo.entity.Calendar calendar = calendarRepository.save(new at.whattudo.entity.Calendar("Test", Lists.newArrayList(organization1)));
    ...
    public void removeCalendarFromOrga() {
        ...
        Organization organization1 = organizationRepository.save(new Organization("Orga 1"));
        Organization organization2 = organizationRepository.save(new Organization("Orga 2"));
        at.whattudo.entity.Calendar calendar = calendarRepository.save(new Calendar("Test", Lists.newArrayList(organization1)));
        organization1.getCalendars().add(calendar);
