...
import at.whattudo.endpoint.dto.CalendarCreateDto;
import at.whattudo.endpoint.dto.CalendarDto;
import at.whattudo.endpoint.mapper.CalendarMapper;
import at.whattudo.endpoint.mapper.TestCalendarMapper;
...
public class CalendarEndpoint {
    ...
    public List<CalendarDto> searchCalendarCombo(@RequestParam(value = "name") String name) {
        ...
        try {
            List<at.whattudo.entity.Calendar> fromCalendars = calendarService.findByName(name);
            ...
            Set<at.whattudo.entity.Calendar> calendars = new HashSet<>();
    ...
    public CalendarDto create(@RequestBody CalendarCreateDto dto) {
        try {
            at.whattudo.entity.Calendar calendarEntity = calendarMapper.calendarCreateDtoToCalendar(dto);
    ...
    public CalendarDto editCalendar(@RequestBody CalendarDto dto) {
        try {
            at.whattudo.entity.Calendar calendar = testMapper.calendarDtoToCalendar(dto);
    ...
    public CalendarDto updateOrganizationsForCalendar(@RequestBody CalendarDto dto) {
        try {
            at.whattudo.entity.Calendar calendar = calendarMapper.calendarDtoToCalendar(dto);
